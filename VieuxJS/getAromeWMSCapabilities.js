/*var exports="";
var require="";
exports.getAromeWMSCapabilities=getAromeWMSCapabilities;
var $=require("jquery");
...
function getAromeWMSCapabilities(nomModele){
	...
	function parseWMS(xml) {
		...
		console.log(xml);
		//$("#capaWMS").html(xml);
		$(xml).find("Capability").find("Layer").find("Layer").each(function(){ // boucle sur les balises. On a alors acc�s � $(this) pour chercher les sous-balises.
